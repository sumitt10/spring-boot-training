...
* The original package name 'com.example.join-nativequery.Customer-Products-demo' is invalid and this project uses 'com.example.joinnativequery.CustomerProductsdemo' instead.
